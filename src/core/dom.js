...
/* build:replaceWith(api) */ rangy /* build:replaceEnd */
  .createCoreModule("DomUtil", [], function (api, module) {
    ...
    function getCommonAncestor(node1, node2) {
      var ancestors = [],
        n;
      for (var n = node1; n; n = n.parentNode) {
        ancestors.push(n);
      }

      for (var n = node2; n; n = n.parentNode) {
