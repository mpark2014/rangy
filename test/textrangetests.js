xn.test.suite(
  ...
  function (s) {
    ...
    s.test("Next/previous node tests", function (t) {
      ...
      t.assertArraysEquivalent(previouses.slice(0, 6), [
        text3,
        i2,
        text2,
        b1,
    ...
    s.test("innerText() with ignored characters", function (t) {
      ...
      t.assertEquals(rangy.innerText(t.el, { ignoreCharacters: ["3"] }), "12");
      t.assertEquals(
        rangy.innerText(t.el, { ignoreCharacters: ["2", "3"] }),
        "1"
      );
    });
    ...
    s.test("innerText() with ignored space characters", function (t) {
      ...
      t.assertEquals(rangy.innerText(t.el), "1\u00a0 2");
      t.assertEquals(
        rangy.innerText(t.el, { ignoreCharacters: "\u00a0" }),
        "1 2"
      );
      t.assertEquals(
        rangy.innerText(t.el, { ignoreCharacters: " " }),
    ...
    s.test("moveStart characters with br", function (t) {
      ...
      var textNode1 = t.el.firstChild,
        textNode2 = t.el.lastChild;
      var range = rangy.createRange();
    ...
    s.test("expand in text node, include trailing space", function (t) {
      ...
      t.assert(
        range.expand("word", { wordOptions: { includeTrailingSpace: true } })
      );
    ...
    s.test("createWordIterator", function (t) {
      ...
      rangy.noMutation(function () {
        ...
        iterator = rangy.createWordIterator(t.el.firstChild, 10, {
          direction: "backward",
        });
...
*/
    ...
    s.test(
      ...
      function (t) {
        t.el.innerHTML = "<p>x </p> <p> y</p>";
        t.assertEquals(
          rangy.innerText(t.el, { includeBlockContentTrailingSpace: false }),
          "x\ny"
        );
        t.assertEquals(
          rangy.innerText(t.el, { includeBlockContentTrailingSpace: true }),
          "x \ny"
        );
      }
    );
...
*/
      ...
      t.assertEquals(
        visibleSpaces(rangy.innerText(t.el)),
        visibleSpaces("X Y")
      );
